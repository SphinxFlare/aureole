...
//       this.rtcConfig = {
//         iceServers,             // ← use ALL the servers Metered gives you
//         iceTransportPolicy: "relay",  // ← FORCE TURN (fixes 99% ICE failures)
//       };
...
//             } else {
//                console.warn("Caller skipping offer; PC not stable:", pc.signalingState);
//             }
//         } else {
...
//     // Only handle offers when we're in a clean state.
//     // You are NOT doing renegotiation, so we keep it strict.
//     if (state !== "stable") {
//       console.warn(
//         "[CallService] Ignoring remote offer; invalid PC signalingState:",
//         state
//       );
//       return;
//     }
...
//     } catch (err) {
//       console.error("[CallService] setLocalDescription(answer) failed:", err);
//       return;
//     }
